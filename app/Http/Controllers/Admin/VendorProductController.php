...
class VendorProductController extends Controller
{
    ...
    {
        $this->middleware('permission:view seller-product')->only('index');
        $this->middleware('permission:create seller-product')->only(['create', 'store']);
        $this->middleware('permission:edit seller-product')->only(['edit', 'update']);
        $this->middleware('permission:delete seller-product')->only('destroy');
    }
