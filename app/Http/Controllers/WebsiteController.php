...
class WebsiteController extends Controller
{
    ...
    public function index()
    {
        ...
        $banners = Bannar::where('status',1)->get();
        return view('frontend.index', compact('setting', 'categories','banners'));
    }
    ...
    public function checkout()
    {
        ...
        $item=Setting::first();
        return view('frontend.checkout', compact('ssl','item'));
    }
    ...
    public function orderStore(Request $request)
    {
        ...
        $order = Order::create([
            ...
            'coupon_code' => $request->coupon_code ?? null,  // ✅ store coupon code
            'coupon' => $request->coupon_amount ?? 0,        // ✅ store coupon amount
        ]);
        ...
        foreach ($request->items as $item) {
            OrderItem::create([
                ...
                'referal_id' => $item['affiliateRefaral'] ?? null, // Ensure affiliate_id is passed
