<nav id="sidebar">
    ...
    <ul class="nav flex-column mt-3">
        ...
        'create commission-level','edit commission-level','view commission-level','delete commission-level'
        ])
        @php
        ...
        <li class="nav-item">
            ...
            <div class="collapse {{ $websiteActive ? 'show' : '' }}" id="websiteMenu">
                <ul class="nav flex-column ms-3">
                    ...
                    @endcanany
                    @canany(['create commission-level','edit commission-level','view commission-level','delete commission-level'])
        ...
        @canany(['create camping','edit camping','view camping','delete camping'])
        @php
        ...
        @php
        $userActive = request()->is('admin/users*') || request()->is('admin/roles*') || request()->is('admin/çustomer-contact*');
        @endphp
        <li class="nav-item">
            ...
            <div class="collapse {{ $userActive ? 'show' : '' }}" id="userManagementMenu">
                <ul class="nav flex-column ms-3">
                    ...
                    <li>
                        <a class="nav-link {{ request()->is('admin/çustomer-contact*') ? 'active' : '' }}" href="{{ route('admin.çustomer-contact.index') }}">
                            Customer
                        </a>
                    </li>
                    @endcanany
