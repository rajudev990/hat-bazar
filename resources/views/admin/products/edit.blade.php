                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card mb-4 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Youtube Video Reivew</label>
                                    <input type="text" name="review_video" class="form-control" value="{{ $product->review_video }}">
                                    @if($product->review_video)
                                    @php
                                        // YouTube URL থেকে ভিডিও ID বের করা
