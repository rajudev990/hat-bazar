    ...
    <div class="container">
        <div class="card shadow-lg rounded-3 overflow-hidden">
            ...
            <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-center text-white bg-gradient-purple">
                <h5 class="mb-2 mb-md-0">Customers List</h5>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        <a href="{{ route('admin.çustomer-contact.edit',$item->id) }}" class="btn btn-sm btn-primary p-2 rounded-circle">
                                            <i class="fa fa-edit text-xs"></i>
                                        </a>
                                       
                                    <form id="delete-form-{{ $item->id }}" action="{{ route('admin.çustomer-contact.destroy', $item->id) }}" method="POST" class="d-none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
